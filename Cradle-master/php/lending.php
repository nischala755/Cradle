...
if ($action == 'lend') {
    ...
    // Prepare an SQL statement to insert the lending transaction
...
// Handle the request to get lending transactions
if ($action == 'get_lending') {
    // Prepare SQL statement to fetch all lending transactions for the logged-in user
